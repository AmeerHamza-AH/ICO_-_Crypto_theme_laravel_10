    ...
    <main>
        ...
        <section class="banner-area-two">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="banner-content text-center">
                            <h2 class="title wow fadeInDown" data-wow-delay=".2s">World’s Biggest ICO Cryptocurrency
                                Platform for you</h2>
            ...
            <div class="banner-social-wrap">
                <ul>
                    <li><a href="#" class="banner-social-link"><i
                                class="fab fa-linkedin-in"></i></a><span>LinkedIn</span></li>
                    <li><a href="#" class="banner-social-link"><i class="fab fa-twitter"></i></a><span>Twitter</span>
                    </li>
                    <li><a href="#" class="banner-social-link"><i
                                class="fab fa-pinterest"></i></a><span>Pinterest</span></li>
                    <li><a href="#" class="banner-social-link"><i
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content-two wow fadeInRight" data-wow-delay=".2s">
                            ...
                            <a href="assets/img/images/h2_about_img.png" download target="_blank" class="btn btn-two">Download
                                Document</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="roadmap-wrap-two">
                            ...
                            <div class="roadmap-item">
                                ...
                                <div class="roadmap-content">
                                    ...
                                    <p>Public testnet launch <br> SubQuery Network Explorer and dApp <br> Point-in-time
                                        indexing</p>
                                </div>
                            </div>
                            <div class="roadmap-item">
                                ...
                                <div class="roadmap-content">
                                    ...
                                    <p>Launch of the SubQuery Foundation Finalise research for other Layer-1 chains
                                        Liquidity mining program</p>
                                </div>
                            </div>
                            <div class="roadmap-item">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <p>LessAccounting is 100% web-based, meaning it can be accessed from
                                                anywhere and there’s no software to install on your computer. You can
                                                easily use LessAccounting on your iPhone or any Android mobile device
                                                with our cloud accounting. That is what makes it the best small business
                                                accounting software options among accounting programs.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
